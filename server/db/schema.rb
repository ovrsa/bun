...
ActiveRecord::Schema[7.1].define(version: 2024_07_21_005936) do
  ...
  create_table "financial_summaries", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["company_id"], name: "index_financial_summaries_on_company_id"
  end
  ...
  add_foreign_key "financial_summaries", "companies"
